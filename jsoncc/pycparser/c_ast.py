...
class Decl(Node):
    def __init__(self, name, quals, storage, funcspec, type, init, bitsize, json, coord=None):
        self.name = name
        self.quals = quals
    ...
    attr_names = ('name','quals','storage','funcspec','json',)
...
class Struct(Node):
    def __init__(self, name, decls, json, coord=None):
        self.name = name
        self.decls = decls
        self.json = json
        self.coord = coord
...
class Typedef(Node):
    def __init__(self, name, quals, storage, type, json, coord=None):
        self.name = name
        self.quals = quals
        self.storage = storage
        self.type = type
    ...
    attr_names = ('name','quals','storage','json',)
...
class Json(Node):
    def __init__(self, mode, flags, decl, coord=None):
        self.mode = mode
        self.flags = flags
        self.decl = decl
        self.coord = coord
